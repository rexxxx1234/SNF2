...
# result dir
result_dir = os.path.join(d, "results/cellline/ov")
if not os.path.exists(result_dir):
    os.makedirs(result_dir)


# read the data
testdata_CCLE = "/scratch/gobi2/rexma/snf2_cellline/CCLE/OV"
testdata_gCSI = "/scratch/gobi2/rexma/snf2_cellline/gCSI/OV"
testdata_GDSC = "/scratch/gobi2/rexma/snf2_cellline/GDSC/OV"

cnv_CCLE = os.path.join(testdata_CCLE, "cnv_49x22742.csv")
cnv_gCSI = os.path.join(testdata_gCSI, "cnv_19x26166.csv")
cnv_GDSC = os.path.join(testdata_GDSC, "cnv_42x22709.csv")

rna_CCLE = os.path.join(testdata_CCLE, "rna_52x20024.csv")
rna_gCSI = os.path.join(testdata_gCSI, "rna_46x60662.csv")
rna_GDSC = os.path.join(testdata_GDSC, "rna_21x11894.csv")

mut_CCLE = os.path.join(testdata_CCLE, "mut_51x1667.csv")
mut_gCSI = os.path.join(testdata_gCSI, "mut_9x45.csv")
mut_GDSC = os.path.join(testdata_GDSC, "mut_40x278.csv")
