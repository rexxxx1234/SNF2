...
rppa_ = os.path.join(testdata_dir, "rppa_887x222.csv")
...
# t-sne extraction
result_dir = os.path.join(d, "results/BRCA")
...
np.savetxt(
    os.path.join(result_dir, "tsne_embedding/w1_tsne.csv"), w1_tsne, delimiter=","
)

w2_tsne = tsne_p(S2_fused.values, no_dims=50)
np.savetxt(
    os.path.join(result_dir, "tsne_embedding/w2_tsne.csv"), w2_tsne, delimiter=","
)

w3_tsne = tsne_p(S3_fused.values, no_dims=50)
np.savetxt(
    os.path.join(result_dir, "tsne_embedding/w3_tsne.csv"), w3_tsne, delimiter=","
)

w4_tsne = tsne_p(S4_fused.values, no_dims=50)
np.savetxt(
    os.path.join(result_dir, "tsne_embedding/w4_tsne.csv"), w4_tsne, delimiter=","
)

w5_tsne = tsne_p(S5_fused.values, no_dims=50)
np.savetxt(
    os.path.join(result_dir, "tsne_embedding/w5_tsne.csv"), w5_tsne, delimiter=","
)
