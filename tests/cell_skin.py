...
# result dir
result_dir = os.path.join(d, "results/cellline/skin")
if not os.path.exists(result_dir):
    os.makedirs(result_dir)


# read the data
testdata_CCLE = "/scratch/gobi2/rexma/snf2_cellline/CCLE/Skin"
testdata_gCSI = "/scratch/gobi2/rexma/snf2_cellline/gCSI/Skin"
testdata_GDSC = "/scratch/gobi2/rexma/snf2_cellline/GDSC/Skin"

cnv_CCLE = os.path.join(testdata_CCLE, "cnv_57x22770.csv")
cnv_gCSI = os.path.join(testdata_gCSI, "cnv_25x26166.csv")
cnv_GDSC = os.path.join(testdata_GDSC, "cnv_52x22773.csv")

rna_CCLE = os.path.join(testdata_CCLE, "rna_61x20024.csv")
rna_gCSI = os.path.join(testdata_gCSI, "rna_52x60662.csv")
rna_GDSC = os.path.join(testdata_GDSC, "rna_41x11894.csv")

mut_CCLE = os.path.join(testdata_CCLE, "mut_59x1667.csv")
mut_gCSI = os.path.join(testdata_gCSI, "mut_21x45.csv")
mut_GDSC = os.path.join(testdata_GDSC, "mut_55x278.csv")
