...
# read the data
testdata_dir = "/scratch/gobi2/rexma/snf2_cancers/LUAD"
#testdata_dir = os.path.join(d, "data/snf2_cancers/LUAD")
cnv_ = os.path.join(testdata_dir, "cnv_516x24776.csv")
meth_ = os.path.join(testdata_dir, "meth_458x16565.csv")
mirna_ = os.path.join(testdata_dir, "mirna_457x1046.csv")
rnaseq_ = os.path.join(testdata_dir, "rnaseq_515x20531.csv")
rppa_ = os.path.join(testdata_dir, "rppa_365x195.csv")
...
# t-sne extraction
result_dir = os.path.join(d, "results/LUAD")
...
plt.title("t-SNE visualization of union LUAD patients")
...
survival_ = os.path.join(testdata_dir, "LUAD_survival.csv")
